  ...
  <div data-custom-class="body">
            ...
            <span style={{ color: "rgb(89, 89, 89)" }}>
              <strong>
                <span data-custom-class="subtitle">
                  Last updated <bdt className="question">October 15, 2023</bdt>
                </span>
              </strong>
            </span>
          </span>
            ...
            <bdt data-type="conditional-block">
              ...
              <bdt data-type="body">
                ...
                <bdt
                  ...
                  data-type="question"
                >
                  aniframe20@gmail.com
                </bdt>{" "}
                to obtain a Return Merchandise{" "}
                <bdt className="block-component" />
                Authorisation
                <bdt className="else-block" /> (RMA) number. After receiving a
                RMA number,&nbsp;
              </bdt>
            </bdt>
          ...
          >
            <bdt data-type="conditional-block">
              ...
              <bdt data-type="body">
                ...
                <bdt
                  className="block-container question question-in-editor"
                  data-id="fdc61623-610d-1b45-fde5-a054a7655485"
                  data-type="question"
                >
                  Just the item along with the packaging we provide if possible
                  by them{" "}
                </bdt>
                , then
              </bdt>
    ...
    <div>
      ...
      <div data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
        ...
        >
          <bdt className="question">
            There are certain items that cannot be returned and are specified in
      ...
      <div data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: 15 }}>
          <bdt className="question">
            <span style={{ color: "rgb(89, 89, 89)" }}>7778004969</span>
          </bdt>
          <span style={{ color: "rgb(89, 89, 89)" }}>
            <bdt className="statement-end-if-in-editor" />
          </span>
